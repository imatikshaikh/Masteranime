...
<head>
    ...
    <link rel="icon" type="image/ico" href={{ asset('favicon.icon') }}/>
    <meta name="description" content=<?php if (isset($description)) { echo '"'.$description.'"'; } else { echo '"Masteranime allows you to stream anime at high quality for desktop, tablet and mobile users! We also offer cool features like auto-updating your own MyAnimeList!"'; }?>>
    <meta name="keywords" content="masteranime, watch, anime, online, hd, high quality, stream, mobile, tablet, 720p, anime videos, watch subbed anime, english subs, animelist, ongoing, completed">

    <!-- for Facebook -->
    <meta property="og:image"       content={{ $social_image or asset('img/masteranime_logo.png') }}/>
    <meta property="og:title"       content=<?php if (isset($title)) { echo '"'.$title.'"'; } else { '"MasterAnime - Stream anime in HD"'; } ?>/>
    <meta property="og:description" content=<?php if (isset($description)) { echo '"'.$description.'"'; } else { echo '"Masteranime allows you to stream anime at high quality for desktop, tablet and mobile users! We also offer cool features like auto-updating your own MyAnimeList!"'; }?>/>
    ...
    <meta name="twitter:title" content=<?php if (isset($title)) { echo '"'.$title.'"'; } else { '"MasterAnime - Stream anime in HD"'; } ?>/>
    <meta name="twitter:description" content=<?php if (isset($description)) { echo '"'.$description.'"'; } else { echo '"Masteranime allows you to stream anime at high quality for desktop, tablet and mobile users! We also offer cool features like auto-updating your own MyAnimeList!"'; }?>/>
