...
<div class="row-fluid">
    <div class="span12">
        <div class="met_page_title">
            ...
            <p>The XBMC add-on with all ongoing anime & over 400+ completed anime available in SD and HD</p>
        </div>
    </div>
</div>
<div class="row-fluid">
        ...
        <div class="met_kabubu_accordion">
            <div class="met_kabubu_accordion_item met_kabubu_accordion_item_active">
                ...
                <div class="met_kabubu_accordion_detail">
                    ...
                    <p class="met_kabubu_accordion_descr" style="display: block;">AnimeHD is available at <a
                            href="https://github.com/NexPB/plugin.video.masterani">Github</a> just download the zip file
            ...
            <div class="met_kabubu_accordion_item">
                ...
                <div class="met_kabubu_accordion_detail">
                    ...
                    <p class="met_kabubu_accordion_descr">XBMC is an award-winning free and open source (GPL) software
                        media player and entertainment hub that can be installed on Linux, OSX, Windows, iOS, and
                        Android, featuring a 10-foot user interface for use with televisions and remote controls. It
                        allows users to play and view most videos, music, podcasts, and other digital media files from
